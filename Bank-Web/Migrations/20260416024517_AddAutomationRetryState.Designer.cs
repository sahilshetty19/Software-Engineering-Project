...
namespace Bank_Web.Migrations
{
    ...
    [Migration("20260416024517_AddAutomationRetryState")]
    partial class AddAutomationRetryState
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bank.Web.Models.KycUploadDetails", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AutomationLockedUntilUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<short>("AutomationStatus")
                        .HasColumnType("smallint");
                    ...
                    b.Property<DateTimeOffset?>("LastAutomationCompletedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("LastAutomationError")
                        .HasColumnType("text");

                    b.Property<DateTimeOffset?>("LastAutomationStartedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("AutomationLockedUntilUtc");
                    ...
                    b.HasIndex("AutomationStatus", "NextRetryAtUtc");
